...
<head>
<meta http-equiv="refresh" content="30; url='http://the-intruders.csec.chatzi.org/modules/conference/messageList.php'" />
...
foreach ($fileReverse as $thisLine) {
		$thisLine = htmlspecialchars($thisLine); // MY CODE
