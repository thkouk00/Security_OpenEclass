...
cData;
	...
	$questionName=xss_sql_filter($objQuestion->selectTitle()); // MY CODE
	$questionDescription=xss_sql_filter($objQuestion->selectDescription());// MY CODE
	// is picture set ?
	...
	$exerciseId = xss_sql_filter($exerciseId); // MY CODE
