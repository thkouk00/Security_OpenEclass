...
$tool_content .= "<form action='$_SERVER[PHP_SELF]' method='post'>$langUsername: <input type='text' name='username' /></form><input type='hidden' name='csrfToken' value='".$_SESSION['csrfToken']."'/></form>";
