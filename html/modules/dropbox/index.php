...
if (!isset($_GET['mailing']))  // RH: Mailing detail: no received files
{
	...
	if ($numberDisplayed > 0)
	{
      ...
      <th width='3' style='border: 1px solid #edecdf'>
        <a href='dropbox_submit.php?deleteReceived=all&amp;dropbox_unid=$dr_unid' onClick=\"return confirmationall('".htmlspecialchars($dropbox_lang['all'])."');\"><img src='../../images/delete.gif' title='$langDelete' /></a></th>";
	}
