...
//shortcut for both xss and sql injection safety
...
function make_clickable_path($dbTable, $path)
{
	...
	foreach (explode('/', $path) as $component) {
		if (empty($component)) {
			...
			$component = xss_sql_filter($component); /* END */
...
{        global $navigation, $cours_id, $is_adminOfCourse, $mysqlMainDb;
				/* MY CODE BEGINS */
					$cours_id = intval($cours_id); //SQL INJECTION FIX
					 /* END */
