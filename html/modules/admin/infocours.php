...
if (isset($submit))  {
  ...
  // END 
	...
	$sql = mysql_query("UPDATE cours SET faculte='$facname', titulaires='$titulaires', intitule='$intitule', faculteid='".intval($facid)."' WHERE code='".mysql_real_escape_string($_GET['c'])."'");
