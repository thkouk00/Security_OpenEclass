        ...
        <table width="99%" class="WikiSum">' . "\n";
            ...
            if ( is_array( $wikiList ) && count( $wikiList ) > 0 )
            {
                ...
                foreach ( $wikiList as $entry )
                {
                    ...
                    $tool_content .= '<a class="item'.htmlspecialchars($classItem).'" href="page.php?wikiId='
                   ...
                   if ( ! empty( $entry['description'] ) )
                    ...
                    $tool_content .= '<a href="page.php?wikiId=' . htmlspecialchars($entry['id']) . '&amp;action=all">';
                    ...
                    $tool_content .= '<a href="page.php?wikiId='
                        . htmlspecialchars($entry['id']).'&amp;action=recent'
                        . '">'
