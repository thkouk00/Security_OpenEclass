		        ...
		        $main_content .= "\n      <p class='success_small'>$langCourseUnitModified</p>";
                  ...
                  $order = intval($order);
                        ...
                        db_query("INSERT INTO course_units SET
                                         title = ".autoquote($title).", comments = ".autoquote($descr).",
