...
/* BEGIN */
$totalScore = xss_sql_filter($totalScore);// MY CODE
$totalWeighting = xss_sql_filter($totalWeighting);// MY CODE
$attempt = xss_sql_filter($attempt);// MY CODE
$eurid = intval($eurid);// MY CODE
/* END */
